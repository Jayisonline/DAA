//Strassens Matrix Multiplication Algorithum
...
int main() {
    ...
    // vector<vector<int>> b = {{10, 7, 7}, {3, 11, 2}, {3, 5, 10}};

    if (m == x)
        Strassen_algorithm(a, b, n, m, x, y);
    else
        cout << -1 << '\n';
    return 0;
}
...
// Time Complexity will be O(n^log7) ~ O(n^2.81)